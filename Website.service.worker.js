...
/** @type {string} */
const CACHE_VERSION = '1724717421|10198663353';
/** @type {string} */
const CACHE_PREFIX = 'Jay (Dorcat)-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["Website.html","Website.js","Website.offline.html","Website.icon.png","Website.apple-touch-icon.png","Website.worker.js","Website.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Website.wasm","Website.pck"];
